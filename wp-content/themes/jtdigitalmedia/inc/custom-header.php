...
add_action( 'after_setup_theme', 'jtdigitalmedia_custom_header_setup' );

if ( ! function_exists( 'jtdigitalmedia_header_style' ) ) :
/**
 * Styles the header image and text displayed on the blog.
 *
 * @see jtdigitalmedia_custom_header_setup().
 */
function jtdigitalmedia_header_style() {
